...
execute_process(
  COMMAND "/sw/ubuntu-22.04/git/current/bin/git" --git-dir=.git show-ref "v3.3.2"
  WORKING_DIRECTORY "/u/jnt6mq/sipc-brandon_zhu/_deps/catch2-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/u/jnt6mq/sipc-brandon_zhu/_deps/catch2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/u/jnt6mq/sipc-brandon_zhu/_deps/catch2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
