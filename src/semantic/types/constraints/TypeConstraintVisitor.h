...
public:
  ...
  /**
   * Construct a TypeConstraintVisitor from the given SymbolTable and
   * ConstraintHandler.
   *
   * Subclasses define the handler (eg. TypeConstraintUnifyVisitor defines the
   * ConstraintUnfier as its handler) and pass it up to the base class during
   * construction. This allows us to not call virtual methods in the
   * constructor.
   *
   * Scott Meyers defines this pattern in his Effective C++ series. You can read
   * more about it here, https://www.aristeia.com/EC3E/3E_item9.pdf.
   */
